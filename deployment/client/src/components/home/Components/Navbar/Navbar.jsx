...
const Navbar = () => {
  ...
  return (
    <nav className='nav'>
      <img src={icon} alt="SuperCert Logo" className='logo' />
        ...
        <li>
          <div class="dropdown btn">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
              ...
              <li><a class="dropdown-item" href="/verifier-login">Verifier</a></li>
              <li><hr class="dropdown-divider" /></li>
              <li><a class="dropdown-item" href="/verifier-register">Register as Verifier</a></li>
            </ul>
          </div>
        </li>
      </ul>
